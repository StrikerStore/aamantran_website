...
import { cardDescription, cardHighlights, cardOccasionLabels, templateArtAlt, templateDemoUrl } from '@/lib/templateCard';
      ...
      <div className={styles.body}>
        ...
        <div className={styles.footer}>
          ...
          {t.tryWithNames && (
            ...
            <Link href={`${productHref}?try=1`} className={styles.try}>
              {TRY_DEMO.cta}
