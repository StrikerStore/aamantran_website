 ...
 * `a` is what the accordion renders; `aText` is a plain-text version for the
 * FAQPage JSON-LD and is only needed when `a` contains JSX.
 */
...
export function faqPlainText(faq: FaqEntry): string {
  if (faq.aText) return faq.aText;
  return typeof faq.a === 'string' ? faq.a : '';
}
    ...
    faqs: [
      {
        ...
        a: <span>Choose a template on the <Link href="/templates">templates page</Link>, pay securely for your <strong>digital e-invitation</strong> (no physical printed cards are shipped), and you&apos;ll set up your couple dashboard. From there, fill in your details and your invitation is live — no waiting, no approvals.</span>,
        aText: "Choose a template on the templates page, pay securely for your digital e-invitation (no physical printed cards are shipped), and you'll set up your couple dashboard. From there, fill in your details and your invitation is live — no waiting, no approvals.",
      },
